...
{
    public class ProductDbHelper : IDbHelper
    {
        private readonly IDbService _dbService;
        private IMapper _mapper;
        public ProductDbHelper(WowCarryContext context, IMapper mapper, IDbService dbService)
        {
            _dbService = dbService;
            _mapper = mapper;
        }
        public async Task<List<T>> GetList<T>(int skip, int qty)
        {
            _dbService.
